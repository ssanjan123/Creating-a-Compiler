        ...
        PushD        $print-format-character   
        Printf                                 
        Label        -SCBooleanOr-15-start     
        PushI        0                         
        Nop                                    
        Label        -SCBooleanOr-15-arg1Done  
        Duplicate                              
        JumpTrue     -SCBooleanOr-15-short-circuit-true 
        Pop                                    
        Label        -SCBooleanOr-15-arg2Start 
        PushI        0                         
        Nop                                    
        Label        -SCBooleanOr-15-arg2Done  
        Jump         -SCBooleanOr-15-end       
        Label        -SCBooleanOr-15-short-circuit-true 
        Label        -SCBooleanOr-15-end       
        ...
        PushD        $print-format-character   
        Printf                                 
        Label        -booleanNegate-17-args-start 
        Label        -booleanNegate-17-arg1    
        PushI        1                         
        Nop                                    
        Label        -booleanNegate-17-start   
        BNegate                                
        Duplicate                              
        JumpFalse    -booleanNegate-17-end     
        Pop                                    
        PushI        1                         
        Label        -booleanNegate-17-end     
        ...
        PushD        $print-format-character   
        Printf                                 
        Label        -booleanNegate-19-args-start 
        Label        -booleanNegate-19-arg1    
        PushI        0                         
        Nop                                    
        Label        -booleanNegate-19-start   
        BNegate                                
        Duplicate                              
        JumpFalse    -booleanNegate-19-end     
        Pop                                    
        PushI        1                         
        Label        -booleanNegate-19-end     
