        ...
        StoreI                                 
        Label        -arrayLength-4-args-start 
        Label        -arrayLength-4-arg1       
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% farm
        LoadI                                  
        Nop                                    
        Label        -arrayLength-4-start      
        Duplicate                              
        JumpFalse    -arrayLength-4-null       
        PushI        12                        
        Add                                    
        LoadI                                  
        Jump         -arrayLength-4-end        
        Label        -arrayLength-4-null       
        Pop                                    
        PushI        -1                        
        Label        -arrayLength-4-end        
