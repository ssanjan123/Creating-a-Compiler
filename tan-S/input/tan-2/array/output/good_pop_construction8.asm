        ...
        PushI        15                        
        Add                                    %% good
        Label        -SCBooleanAnd-34-start    
        Label        -SCBooleanAnd-33-start    
        Label        -SCBooleanAnd-32-start    
        Label        -SCBooleanAnd-31-start    
        Label        -SCBooleanAnd-30-start    
        Label        -SCBooleanAnd-29-start    
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% elem1
        LoadC                                  
        Nop                                    
        Label        -SCBooleanAnd-29-arg1Done 
        Duplicate                              
        JumpFalse    -SCBooleanAnd-29-short-circuit-false 
        Pop                                    
        Label        -SCBooleanAnd-29-arg2Start 
        PushD        $global-memory-block      
        PushI        9                         
        Add                                    %% elem2
        LoadC                                  
        Nop                                    
        Label        -SCBooleanAnd-29-arg2Done 
        Jump         -SCBooleanAnd-29-end      
        Label        -SCBooleanAnd-29-short-circuit-false 
        Label        -SCBooleanAnd-29-end      
        Nop                                    
        Label        -SCBooleanAnd-30-arg1Done 
        Duplicate                              
        JumpFalse    -SCBooleanAnd-30-short-circuit-false 
        Pop                                    
        Label        -SCBooleanAnd-30-arg2Start 
        PushD        $global-memory-block      
        PushI        10                        
        Add                                    %% elem3
        LoadC                                  
        Nop                                    
        Label        -SCBooleanAnd-30-arg2Done 
        Jump         -SCBooleanAnd-30-end      
        Label        -SCBooleanAnd-30-short-circuit-false 
        Label        -SCBooleanAnd-30-end      
        Nop                                    
        ...
        Nop                                    
        Label        -SCBooleanAnd-32-arg1Done 
        Duplicate                              
        JumpFalse    -SCBooleanAnd-32-short-circuit-false 
        Pop                                    
        Label        -SCBooleanAnd-32-arg2Start 
        PushD        $global-memory-block      
        PushI        12                        
        Add                                    %% elem5
        LoadC                                  
        Nop                                    
        Label        -SCBooleanAnd-32-arg2Done 
        Jump         -SCBooleanAnd-32-end      
        Label        -SCBooleanAnd-32-short-circuit-false 
        Label        -SCBooleanAnd-32-end      
        Nop                                    
        Label        -SCBooleanAnd-33-arg1Done 
        Duplicate                              
        JumpFalse    -SCBooleanAnd-33-short-circuit-false 
        Pop                                    
        Label        -SCBooleanAnd-33-arg2Start 
        PushD        $global-memory-block      
        PushI        13                        
        Add                                    %% elem6
        LoadC                                  
        Nop                                    
        Label        -SCBooleanAnd-33-arg2Done 
        Jump         -SCBooleanAnd-33-end      
        Label        -SCBooleanAnd-33-short-circuit-false 
        Label        -SCBooleanAnd-33-end      
        Nop                                    
        Label        -SCBooleanAnd-34-arg1Done 
        Duplicate                              
        JumpFalse    -SCBooleanAnd-34-short-circuit-false 
        Pop                                    
        Label        -SCBooleanAnd-34-arg2Start 
        PushD        $global-memory-block      
        PushI        14                        
        Add                                    %% elem7
        LoadC                                  
        Nop                                    
        Label        -SCBooleanAnd-34-arg2Done 
        Jump         -SCBooleanAnd-34-end      
        Label        -SCBooleanAnd-34-short-circuit-false 
        Label        -SCBooleanAnd-34-end      
        StoreC                                 
        ...
        Label        -if-37-false              
        Label        -if-37-end                
        Label        -if-40-condition          
        Label        -booleanNegate-38-args-start 
        Label        -booleanNegate-38-arg1    
        PushD        $global-memory-block      
        PushI        15                        
        Add                                    %% good
        LoadC                                  
        Nop                                    
        Label        -booleanNegate-38-start   
        BNegate                                
        Duplicate                              
        JumpFalse    -booleanNegate-38-end     
        Pop                                    
        PushI        1                         
        Label        -booleanNegate-38-end     
        Label        -if-40-branch             
        JumpFalse    -if-40-false              
        DLabel       -stringConstant-39--start 
