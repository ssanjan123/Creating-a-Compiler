        ...
        Label        -arrayLength-3-args-start 
        Label        -arrayLength-3-arg1       
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% barn
        LoadI                                  
        Nop                                    
        Label        -arrayLength-3-start      
        Duplicate                              
        JumpFalse    -arrayLength-3-null       
        PushI        12                        
        Add                                    
        LoadI                                  
        Jump         -arrayLength-3-end        
        Label        -arrayLength-3-null       
        Pop                                    
        PushI        -1                        
        Label        -arrayLength-3-end        
        Nop                                    
