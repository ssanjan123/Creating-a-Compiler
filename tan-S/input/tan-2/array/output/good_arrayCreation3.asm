        ...
        LoadI                                  
        Label        -arrayPrint-20-start      
        Duplicate                              
        JumpTrue     -arrayPrint-20-nonNull    
        Pop                                    
        PushD        $print-null-string        
        Printf                                 
        Jump         -arrayPrint-20-end        
        Label        -arrayPrint-20-nonNull    
        PushD        $array-start-string       
        PushD        $print-format-string      
        Printf                                 
        PushI        0                         
        ...
        Add                                    
        LoadI                                  
        JumpFalse    -arrayPrint-20-loopExit   
        Label        -arrayPrint-20-loop       
        Duplicate                              
        Duplicate                              
        Duplicate                              
        JumpFalse    $$a-null-base-array       
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -arrayPrint-20-loopContinue 
        Jump         -arrayPrint-20-loopExit   
        Label        -arrayPrint-20-loopContinue 
        PushD        $array-middle-string      
        PushD        $print-format-string      
        Printf                                 
        Jump         -arrayPrint-20-loop       
        Label        -arrayPrint-20-loopExit   
        Pop                                    
        PushD        $array-end-string         
        PushD        $print-format-string      
        Printf                                 
        Label        -arrayPrint-20-end        
        PushI        10                        
        PushD        $print-format-character   
        Printf                                 
        PushI        10                        
