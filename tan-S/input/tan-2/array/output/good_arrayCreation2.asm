        ...
        Exchange                               
        StoreI                                 
        Label        -populatedArray-8-startChildren 
        PushD        $record-create-temp       
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Label        -populatedArray-6-startChildren 
        PushD        $record-create-temp       
        LoadI                                  
        PushF        7.300000                  
        Nop                                    
        ...
        Exchange                               
        StoreI                                 
        Label        -populatedArray-7-startChildren 
        PushD        $record-create-temp       
        LoadI                                  
        PushF        6.400000                  
        Nop                                    
        ...
        LoadI                                  
        Exchange                               
        Label        -arrayPrint-12-start      
        Duplicate                              
        JumpTrue     -arrayPrint-12-nonNull    
        Pop                                    
        PushD        $print-null-string        
        Printf                                 
        Jump         -arrayPrint-12-end        
        Label        -arrayPrint-12-nonNull    
        PushD        $array-start-string       
        PushD        $print-format-string      
        Printf                                 
        PushI        0                         
        ...
        Add                                    
        LoadI                                  
        JumpFalse    -arrayPrint-12-loopExit   
        Label        -arrayPrint-12-loop       
        Duplicate                              
        Duplicate                              
        Duplicate                              
        JumpFalse    $$a-null-base-array       
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -arrayPrint-12-loopContinue 
        Jump         -arrayPrint-12-loopExit   
        Label        -arrayPrint-12-loopContinue 
        PushD        $array-middle-string      
        PushD        $print-format-string      
        Printf                                 
        Jump         -arrayPrint-12-loop       
        Label        -arrayPrint-12-loopExit   
        Pop                                    
        PushD        $array-end-string         
        PushD        $print-format-string      
        Printf                                 
        Label        -arrayPrint-12-end        
        PushD        $array-printing-index     
        Exchange                               
        StoreI                                 
        PushI        1                         
