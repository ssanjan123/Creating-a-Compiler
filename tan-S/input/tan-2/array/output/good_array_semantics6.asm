        ...
        Add                                    %% farm
        LoadI                                  
        Label        -arrayPrint-3-start       
        Duplicate                              
        JumpTrue     -arrayPrint-3-nonNull     
        Pop                                    
        PushD        $print-null-string        
        Printf                                 
        Jump         -arrayPrint-3-end         
        Label        -arrayPrint-3-nonNull     
        ...
        Add                                    
        LoadI                                  
        JumpFalse    -arrayPrint-3-loopExit    
        Label        -arrayPrint-3-loop        
        Duplicate                              
        Duplicate                              
        Duplicate                              
        JumpFalse    $$a-null-base-array       
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -arrayPrint-3-loopContinue 
        Jump         -arrayPrint-3-loopExit    
        Label        -arrayPrint-3-loopContinue 
        PushD        $array-middle-string      
        PushD        $print-format-string      
        Printf                                 
        Jump         -arrayPrint-3-loop        
        Label        -arrayPrint-3-loopExit    
        Pop                                    
        PushD        $array-end-string         
        PushD        $print-format-string      
        Printf                                 
        Label        -arrayPrint-3-end         
        PushI        32                        
        ...
        Add                                    %% farm
        LoadI                                  
        Label        -arrayPrint-7-start       
        Duplicate                              
        JumpTrue     -arrayPrint-7-nonNull     
        Pop                                    
        PushD        $print-null-string        
        Printf                                 
        Jump         -arrayPrint-7-end         
        Label        -arrayPrint-7-nonNull     
        PushD        $array-start-string       
        PushD        $print-format-string      
        Printf                                 
        PushI        0                         
        ...
        Add                                    
        LoadI                                  
        JumpFalse    -arrayPrint-7-loopExit    
        Label        -arrayPrint-7-loop        
        Duplicate                              
        Duplicate                              
        Duplicate                              
        JumpFalse    $$a-null-base-array       
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -arrayPrint-7-loopContinue 
        Jump         -arrayPrint-7-loopExit    
        Label        -arrayPrint-7-loopContinue 
        PushD        $array-middle-string      
        PushD        $print-format-string      
        Printf                                 
        Jump         -arrayPrint-7-loop        
        Label        -arrayPrint-7-loopExit    
        Pop                                    
        PushD        $array-end-string         
        PushD        $print-format-string      
        Printf                                 
        Label        -arrayPrint-7-end         
        PushI        32                        
        PushD        $print-format-character   
        Printf                                 
        PushD        $global-memory-block      
