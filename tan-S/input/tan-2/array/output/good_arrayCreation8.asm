        ...
        Add                                    %% BB
        LoadI                                  
        Label        -arrayPrint-6-start       
        Duplicate                              
        JumpTrue     -arrayPrint-6-nonNull     
        Pop                                    
        PushD        $print-null-string        
        Printf                                 
        Jump         -arrayPrint-6-end         
        Label        -arrayPrint-6-nonNull     
        PushD        $array-start-string       
        PushD        $print-format-string      
        Printf                                 
        PushI        0                         
        ...
        Add                                    
        LoadI                                  
        JumpFalse    -arrayPrint-6-loopExit    
        Label        -arrayPrint-6-loop        
        Duplicate                              
        Duplicate                              
        Duplicate                              
        JumpFalse    $$a-null-base-array       
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -arrayPrint-6-loopContinue 
        Jump         -arrayPrint-6-loopExit    
        Label        -arrayPrint-6-loopContinue 
        PushD        $array-middle-string      
        PushD        $print-format-string      
        Printf                                 
        Jump         -arrayPrint-6-loop        
        Label        -arrayPrint-6-loopExit    
        Pop                                    
        PushD        $array-end-string         
        PushD        $print-format-string      
        Printf                                 
        Label        -arrayPrint-6-end         
        PushI        10                        
        PushD        $print-format-character   
        Printf                                 
        PushD        $global-memory-block      
