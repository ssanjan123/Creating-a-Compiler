        ...
        Add                                    %% hay
        LoadI                                  
        Label        -arrayPrint-4-start       
        Duplicate                              
        JumpTrue     -arrayPrint-4-nonNull     
        Pop                                    
        PushD        $print-null-string        
        Printf                                 
        Jump         -arrayPrint-4-end         
        Label        -arrayPrint-4-nonNull     
        ...
        Add                                    
        LoadI                                  
        JumpFalse    -arrayPrint-4-loopExit    
        Label        -arrayPrint-4-loop        
        Duplicate                              
        Duplicate                              
        Duplicate                              
        JumpFalse    $$a-null-base-array       
        ...
        LoadI                                  
        Exchange                               
        Label        -arrayPrint-5-start       
        Duplicate                              
        JumpTrue     -arrayPrint-5-nonNull     
        Pop                                    
        PushD        $print-null-string        
        Printf                                 
        Jump         -arrayPrint-5-end         
        Label        -arrayPrint-5-nonNull     
        PushD        $array-start-string       
        PushD        $print-format-string      
        Printf                                 
        PushI        0                         
        ...
        Add                                    
        LoadI                                  
        JumpFalse    -arrayPrint-5-loopExit    
        Label        -arrayPrint-5-loop        
        Duplicate                              
        Duplicate                              
        Duplicate                              
        JumpFalse    $$a-null-base-array       
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -arrayPrint-5-loopContinue 
        Jump         -arrayPrint-5-loopExit    
        Label        -arrayPrint-5-loopContinue 
        PushD        $array-middle-string      
        PushD        $print-format-string      
        Printf                                 
        Jump         -arrayPrint-5-loop        
        Label        -arrayPrint-5-loopExit    
        Pop                                    
        PushD        $array-end-string         
        PushD        $print-format-string      
        Printf                                 
        Label        -arrayPrint-5-end         
        PushD        $array-printing-index     
        Exchange                               
        StoreI                                 
        PushI        1                         
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -arrayPrint-4-loopContinue 
        Jump         -arrayPrint-4-loopExit    
        Label        -arrayPrint-4-loopContinue 
        PushD        $array-middle-string      
        PushD        $print-format-string      
        Printf                                 
        Jump         -arrayPrint-4-loop        
        Label        -arrayPrint-4-loopExit    
        Pop                                    
        PushD        $array-end-string         
        PushD        $print-format-string      
        Printf                                 
        Label        -arrayPrint-4-end         
        PushI        10                        
        ...
        Add                                    %% hay
        LoadI                                  
        Label        -arrayPrint-8-start       
        Duplicate                              
        JumpTrue     -arrayPrint-8-nonNull     
        Pop                                    
        PushD        $print-null-string        
        Printf                                 
        Jump         -arrayPrint-8-end         
        Label        -arrayPrint-8-nonNull     
        PushD        $array-start-string       
        PushD        $print-format-string      
        Printf                                 
        PushI        0                         
        ...
        Add                                    
        LoadI                                  
        JumpFalse    -arrayPrint-8-loopExit    
        Label        -arrayPrint-8-loop        
        Duplicate                              
        Duplicate                              
        Duplicate                              
        JumpFalse    $$a-null-base-array       
        ...
        LoadI                                  
        Exchange                               
        Label        -arrayPrint-9-start       
        Duplicate                              
        JumpTrue     -arrayPrint-9-nonNull     
        Pop                                    
        PushD        $print-null-string        
        Printf                                 
        Jump         -arrayPrint-9-end         
        Label        -arrayPrint-9-nonNull     
        PushD        $array-start-string       
        PushD        $print-format-string      
        Printf                                 
        PushI        0                         
        ...
        Add                                    
        LoadI                                  
        JumpFalse    -arrayPrint-9-loopExit    
        Label        -arrayPrint-9-loop        
        Duplicate                              
        Duplicate                              
        Duplicate                              
        JumpFalse    $$a-null-base-array       
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -arrayPrint-9-loopContinue 
        Jump         -arrayPrint-9-loopExit    
        Label        -arrayPrint-9-loopContinue 
        PushD        $array-middle-string      
        PushD        $print-format-string      
        Printf                                 
        Jump         -arrayPrint-9-loop        
        Label        -arrayPrint-9-loopExit    
        Pop                                    
        PushD        $array-end-string         
        PushD        $print-format-string      
        Printf                                 
        Label        -arrayPrint-9-end         
        PushD        $array-printing-index     
        Exchange                               
        StoreI                                 
        PushI        1                         
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -arrayPrint-8-loopContinue 
        Jump         -arrayPrint-8-loopExit    
        Label        -arrayPrint-8-loopContinue 
        PushD        $array-middle-string      
        PushD        $print-format-string      
        Printf                                 
        Jump         -arrayPrint-8-loop        
        Label        -arrayPrint-8-loopExit    
        Pop                                    
        PushD        $array-end-string         
        PushD        $print-format-string      
        Printf                                 
        Label        -arrayPrint-8-end         
        PushI        32                        
        PushD        $print-format-character   
        Printf                                 
        PushD        $global-memory-block      
        ...
        Add                                    %% cow
        LoadI                                  
        Label        -arrayPrint-11-start      
        Duplicate                              
        JumpTrue     -arrayPrint-11-nonNull    
        Pop                                    
        PushD        $print-null-string        
        Printf                                 
        Jump         -arrayPrint-11-end        
        Label        -arrayPrint-11-nonNull    
        PushD        $array-start-string       
        PushD        $print-format-string      
        Printf                                 
        PushI        0                         
        ...
        Add                                    
        LoadI                                  
        JumpFalse    -arrayPrint-11-loopExit   
        Label        -arrayPrint-11-loop       
        Duplicate                              
        Duplicate                              
        Duplicate                              
        JumpFalse    $$a-null-base-array       
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -arrayPrint-11-loopContinue 
        Jump         -arrayPrint-11-loopExit   
        Label        -arrayPrint-11-loopContinue 
        PushD        $array-middle-string      
        PushD        $print-format-string      
        Printf                                 
        Jump         -arrayPrint-11-loop       
        Label        -arrayPrint-11-loopExit   
        Pop                                    
        PushD        $array-end-string         
        PushD        $print-format-string      
        Printf                                 
        Label        -arrayPrint-11-end        
        PushI        10                        
        PushD        $print-format-character   
        Printf                                 
        Halt                                   
