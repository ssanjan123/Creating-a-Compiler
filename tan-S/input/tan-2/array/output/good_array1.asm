        ...
        Exchange                               
        StoreI                                 
        Label        -populatedArray-11-startChildren 
        PushD        $record-create-temp       
        LoadI                                  
        PushI        7                         
        Nop                                    
        ...
        Add                                    %% BB
        LoadI                                  
        Label        -arrayPrint-15-start      
        Duplicate                              
        JumpTrue     -arrayPrint-15-nonNull    
        Pop                                    
        PushD        $print-null-string        
        Printf                                 
        Jump         -arrayPrint-15-end        
        Label        -arrayPrint-15-nonNull    
        PushD        $array-start-string       
        PushD        $print-format-string      
        Printf                                 
        PushI        0                         
        ...
        Add                                    
        LoadI                                  
        JumpFalse    -arrayPrint-15-loopExit   
        Label        -arrayPrint-15-loop       
        Duplicate                              
        Duplicate                              
        Duplicate                              
        JumpFalse    $$a-null-base-array       
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -arrayPrint-15-loopContinue 
        Jump         -arrayPrint-15-loopExit   
        Label        -arrayPrint-15-loopContinue 
        PushD        $array-middle-string      
        PushD        $print-format-string      
        Printf                                 
        Jump         -arrayPrint-15-loop       
        Label        -arrayPrint-15-loopExit   
        Pop                                    
        PushD        $array-end-string         
        PushD        $print-format-string      
        Printf                                 
        Label        -arrayPrint-15-end        
        PushI        10                        
        PushD        $print-format-character   
        Printf                                 
        PushD        $global-memory-block      
        ...
        LoadI                                  
        Exchange                               
        Label        -arrayPrint-17-start      
        Duplicate                              
        JumpTrue     -arrayPrint-17-nonNull    
        Pop                                    
        PushD        $print-null-string        
        Printf                                 
        Jump         -arrayPrint-17-end        
        Label        -arrayPrint-17-nonNull    
        PushD        $array-start-string       
        PushD        $print-format-string      
        Printf                                 
        PushI        0                         
        ...
        Add                                    
        LoadI                                  
        JumpFalse    -arrayPrint-17-loopExit   
        Label        -arrayPrint-17-loop       
        Duplicate                              
        Duplicate                              
        Duplicate                              
        JumpFalse    $$a-null-base-array       
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -arrayPrint-17-loopContinue 
        Jump         -arrayPrint-17-loopExit   
        Label        -arrayPrint-17-loopContinue 
        PushD        $array-middle-string      
        PushD        $print-format-string      
        Printf                                 
        Jump         -arrayPrint-17-loop       
        Label        -arrayPrint-17-loopExit   
        Pop                                    
        PushD        $array-end-string         
        PushD        $print-format-string      
        Printf                                 
        Label        -arrayPrint-17-end        
        PushD        $array-printing-index     
        Exchange                               
        StoreI                                 
        PushI        1                         
