        ...
        Add                                    %% i
        LoadI                                  
        Label        -arrayPrint-2-start       
        Duplicate                              
        JumpTrue     -arrayPrint-2-nonNull     
        Pop                                    
        PushD        $print-null-string        
        Printf                                 
        Jump         -arrayPrint-2-end         
        Label        -arrayPrint-2-nonNull     
        ...
        Add                                    
        LoadI                                  
        JumpFalse    -arrayPrint-2-loopExit    
        Label        -arrayPrint-2-loop        
        Duplicate                              
        Duplicate                              
        Duplicate                              
        JumpFalse    $$a-null-base-array       
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -arrayPrint-2-loopContinue 
        Jump         -arrayPrint-2-loopExit    
        Label        -arrayPrint-2-loopContinue 
        PushD        $array-middle-string      
        PushD        $print-format-string      
        Printf                                 
        Jump         -arrayPrint-2-loop        
        Label        -arrayPrint-2-loopExit    
        Pop                                    
        PushD        $array-end-string         
        PushD        $print-format-string      
        Printf                                 
        Label        -arrayPrint-2-end         
        PushI        10                        
